        ...
        get: function get() {
          if (this._traceId == null && this._traceIdStr != null) {
            ...
            if (this._traceIdStr.length === traceIdExactLength) {
              ...
              var paddings = ['0000000000000000', '00000000000000000000000000000000'];
              var paddingIndex = traceIdExactLength === 16 ? 0 : 1;
              var safeTraceIdStr = (paddings[paddingIndex] + this._traceIdStr).slice(-traceIdExactLength);
